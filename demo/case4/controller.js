;(_ => {
  ...
  content1.addEventListener('show', e => {
    console.log('content 1 show');
  });
  content1.addEventListener('hide', e => {
    console.log('content 1 hide');
  });

  content11.addEventListener('show', e => {
    console.log('content 11 show');
  });
  content11.addEventListener('hide', e => {
    console.log('content 11 hide');
  });

  content111.addEventListener('show', e => {
    console.log('content 111 show');
  });
  content111.addEventListener('hide', e => {
